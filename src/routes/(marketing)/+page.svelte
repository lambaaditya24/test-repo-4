  ...
  <div class="hero-content text-center py-12">
    <div class="max-w-xl">
      ...
      <div class="mt-6 md:mt-10 text-sm md:text-lg">
        Built with floss and magic stuff
      </div>
      <div class="mt-6 md:mt-2">
        <a href="https://github.com/W4M-ai">
          <button class="btn btn-primary btn-sm px-6">★ us on Github</button>
        </a>
        <a
          href="https://youtube.com/watch?v=dQw4w9WgXcQ&t=42"
        >
        ...
        <div class="min-w-[270px] lg:min-w-[420px] flex mt-6 lg:mt-0">
          <div class="my-auto">
            <div class="px-4 text-lg md:text-xl">
              <a href="https://W4M.ai" class="" target="_blank"
