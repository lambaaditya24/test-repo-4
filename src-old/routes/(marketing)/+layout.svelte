...
<div class="navbar bg-base-100 container mx-auto">
  <div class="flex-1">
    <a class="btn btn-ghost normal-case text-xl" href="/">W4M.ai - Lead Generation Pro</a>
  </div>
  <div class="flex-none">
    <ul class="menu menu-horizontal px-1 hidden sm:flex font-bold text-lg">
      <li class="md:mx-4">
        <a
          href="https://github.com/W4M-ai"
  ...
  >
    <nav>
      ...
      <a
        ...
        href="https://github.com/W4M-ai">Github</a
      >
    </nav>
    <aside>
      ...
      >
        <img
          alt="W4M Logo"
          src="/images/w4m_logo.svg"
          class="w-[180px] mb-3 aspect-[420/154]"
        />
        Make your SaaS stand out with the help of W4M.ai.
      </a>
    </aside>
  </footer>
</div>
